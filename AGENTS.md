...
- `GET /api/catalog` returns `personaPresets` and `scenarioPresets`. Persona categories are `occupation`, `personality_trait`, `communication_style`, `tone_style`, `motivation`, and `concern`.
